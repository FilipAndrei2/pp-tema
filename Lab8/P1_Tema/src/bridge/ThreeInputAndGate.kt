...
class ThreeInputAndGate(private val input1 : Boolean, private val input2 : Boolean, private val input3 : Boolean, implementation : AndGateImplementation):AndGateAbstaction(implementation)
{
