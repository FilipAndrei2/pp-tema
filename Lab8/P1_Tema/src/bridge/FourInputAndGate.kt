...
class FourInputAndGate(private val input1 : Boolean, private val input2 : Boolean, private val input3 : Boolean, private val input4 : Boolean, implementation : AndGateImplementation):AndGateAbstaction(implementation)
{
